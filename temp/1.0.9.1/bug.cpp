    ...
    for (;;)
    {
        ...
        switch(mode)
        {
        	case AUTO_TRACKING:
        		...
        		{
        			small_target = correlation_tracking(track, image, &first_frame, AUTO_TRACKING, debug_mode);
        		}
        		if(small_target == true)
        		{
        		    small_target = contrast_tracking(&track, image,  &first_frame, AUTO_TRACKING, debug_mode);
        		}
        		break;
            case CORRELATION_TRACKING:
            	correlation_tracking(track, image,  &first_frame, CORRELATION_TRACKING, debug_mode);
            	break;
            case CONTRAST_TRACKING:
            	contrast_tracking(&track, image,  &first_frame, CONTRAST_TRACKING, debug_mode);
                break;
            case NONE_TRACKING:
                break;
        }
